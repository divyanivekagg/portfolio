 ...
 *
 * @license MIT
 */Object.defineProperty(V,"__esModule",{value:!0});const ae=new TextEncoder,Mr=async(e,t)=>{let r=await qe(t,["sign"]),n=ae.encode(e),a=await crypto.subtle.sign("HMAC",r,n),o=btoa(String.fromCharCode(...new Uint8Array(a))).replace(/=+$/,"");return e+"."+o},Ar=async(e,t)=>{let r=e.lastIndexOf("."),n=e.slice(0,r),a=e.slice(r+1),o=await qe(t,["verify"]),s=ae.encode(n),i=Hr(atob(a));return await crypto.subtle.verify("HMAC",o,i,s)?n:!1};async function qe(e,t){return await crypto.subtle.importKey("raw",ae.encode(e),{name:"HMAC",hash:"SHA-256"},!1,t)}function Hr(e){let t=new Uint8Array(e.length);for(let r=0;r<e.length;r++)t[r]=e.charCodeAt(r);return t}V.sign=Mr;V.unsign=Ar;/**
 * @remix-run/cloudflare v2.7.1
 *
 * Copyright (c) Remix Software Inc.
 *
 ...
 *
 * @license MIT
 */Object.defineProperty(T,"__esModule",{value:!0});var q=Ve,Ee=V;const oe=q.createCookieFactory({sign:Ee.sign,unsign:Ee.unsign}),Nr=q.createCookieSessionStorageFactory(oe),Be=q.createSessionStorageFactory(oe),Pr=q.createMemorySessionStorageFactory(Be);T.createCookie=oe;T.createCookieSessionStorage=Nr;T.createMemorySessionStorage=Pr;T.createSessionStorage=Be;/**
 * @remix-run/cloudflare v2.7.1
 *
 * Copyright (c) Remix Software Inc.
 *
